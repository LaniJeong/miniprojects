...
class Ui_FrmMain(object):
    def setupUi(self, FrmMain):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 621, 71))
        ...
        self.widget.setGeometry(QtCore.QRect(10, 30, 601, 31))
    ...
    def retranslateUi(self, FrmMain):
        ...
        FrmMain.setWindowTitle(_translate("FrmMain", "네이버API 뉴스검색 앱"))
